...
const Home = () => {
  ...
  const loadUsers = async () => {
    const result = await axios.get("http://localhost/codei4/show_book");
    setUser(result.data.reverse());
  };

  const deleteUser = (bookId) =>
  {
    axios.delete('http://localhost/codei4/delete-book/delete/'+bookId)
    .then((result)=>{
      loadUsers();
    })
    .catch(()=>{
      ...
      <div className="py-4">
          ...
          <Swiper
            ...
            >
              ...
              <SwiperSlide><div className="mt-0 mb-2"><img src={'http://localhost/codei4/'+user.book} alt="" style={{ width: '100%',height: '20rem',margin: 0,padding: 0}}/></div></SwiperSlide>
              ))}
          </Swiper>
          ...
          <div className="row text-left">
            {users.map((user, index) => (
              <div className="col-md-4 text-center">
                ...
                <div className="mt-0 mb-2"><img src={'http://localhost/codei4/'+user.book} alt="" style={{ width: '100%',height: '20rem',margin: 0,padding: 0}}/></div>
